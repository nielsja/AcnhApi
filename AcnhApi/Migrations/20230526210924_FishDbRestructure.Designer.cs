...
namespace AcnhApi.Migrations
{
    ...
    [Migration("20230526210924_FishDbRestructure")]
    partial class FishDbRestructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcnhApi.DataAccessors.Entities.FishDb", b =>
                {
            ...
            modelBuilder.Entity("AcnhApi.DataAccessors.Entities.UserDb", b =>
                {
            ...
            modelBuilder.Entity("FishDbUserDb", b =>
                {
                    b.Property<string>("FishId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("FishDbUserDb");
                });

            modelBuilder.Entity("FishDbUserDb", b =>
                {
                    b.HasOne("AcnhApi.DataAccessors.Entities.FishDb", null)
                        .WithMany()
                        .HasForeignKey("FishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AcnhApi.DataAccessors.Entities.UserDb", null)
                        .WithMany()
